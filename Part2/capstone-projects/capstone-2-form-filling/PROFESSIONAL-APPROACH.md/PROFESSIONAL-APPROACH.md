...
| # | Question | Why |
|---|----------|-----|
| 1 | Required vs optional fields? | Know which empty fields should fail |
...
**స్టెప్ 2:** టెక్స్ట్ ఇన్పుట్స్ → sendKeys(), రేడియో బటన్స్ → click(), చెక్బాక్సెస్ → click(), డ్రాప్డౌన్స్ → new Select(element), డేట్ పికర్ → sendKeys() with dd/MM/yyyy
